...
PW.FIELDS = [
  ...
  {
    id: 'business-case-attachment', n: 5, name: 'Business Case / Justification Attachment', category: 'Workflow & Approval', type: 'File upload',
  ...
  {
    id: 'position-title', n: 6, name: 'Position Title', category: 'Identity & Status', type: 'Free text',
  ...
  {
    id: 'status', n: 7, name: 'Status', category: 'Identity & Status', type: 'Active / Inactive',
  ...
  {
    id: 'start-date', n: 8, name: 'Start Date', category: 'Identity & Status', type: 'Date',
  ...
  {
    id: 'comment', n: 9, name: 'Comment', category: 'Identity & Status', type: 'Free text',
  ...
  {
    id: 'legal-entity', n: 10, name: 'Legal Entity', category: 'Organisational Structure', type: 'Dropdown',
  ...
  {
    id: 'directorate', n: 11, name: 'Directorate', category: 'Organisational Structure', type: 'Dropdown',
  ...
  {
    id: 'division', n: 12, name: 'Division', category: 'Organisational Structure', type: 'Dropdown (filtered by Directorate)',
  ...
  {
    id: 'department', n: 13, name: 'Department', category: 'Organisational Structure', type: 'Dropdown (filtered by Division)',
  ...
  {
    id: 'sub-department', n: 14, name: 'Sub-Department', category: 'Organisational Structure', type: 'Dropdown (filtered)',
  ...
  {
    id: 'cost-centre', n: 15, name: 'Cost Centre', category: 'Organisational Structure', type: 'Dropdown',
  ...
  {
    id: 'ph-calendar', n: 16, name: 'PH Calendar', category: 'Organisational Structure', type: 'Dropdown',
  ...
  {
    id: 'job-role', n: 17, name: 'Job Role', category: 'Organisational Structure', type: 'Dropdown (contextual)',
  ...
  {
    id: 'parent-position', n: 18, name: 'Parent Position', category: 'Organisational Structure', type: 'Position lookup',
  ...
  {
    id: 'subject-to-position-control', n: 19, name: 'Subject to Position Control', category: 'Organisational Structure', type: 'System-controlled',
  ...
  {
    id: 'employee-status', n: 20, name: 'Employee Status', category: 'Employment Type', type: 'Dropdown',
  ...
  {
    id: 'employment-status', n: 21, name: 'Employment Status', category: 'Employment Type', type: 'Dropdown (filtered by Employee Status)',
  ...
  {
    id: 'hours-per-week', n: 22, name: 'Hours Per Week', category: 'Employment Type', type: 'Numeric',
  ...
  {
    id: 'pay-scale-type', n: 23, name: 'Pay Scale Type', category: 'Classification & Pay', type: 'Dropdown',
  ...
  {
    id: 'pay-scale-area', n: 24, name: 'Pay Scale Area', category: 'Classification & Pay', type: 'Dropdown (filtered)',
  ...
  {
    id: 'pay-scale-group', n: 25, name: 'Pay Scale Group', category: 'Classification & Pay', type: 'Dropdown (filtered)',
  ...
  {
    id: 'pay-scale-level', n: 26, name: 'Pay Scale Level', category: 'Classification & Pay', type: 'Dropdown (filtered)',
  ...
  {
    id: 'ahpra', n: 27, name: 'AHPRA Check Required', category: 'Compliance', type: 'Yes / No',
  ...
  {
    id: 'wwcc', n: 28, name: 'Working with Children Check Required', category: 'Compliance', type: 'Yes / No',
  ...
  {
    id: 'immunisation', n: 29, name: 'Immunisation Category', category: 'Compliance', type: 'Dropdown (A / B / C)',
  ...
  {
    id: 'security-licencing', n: 30, name: 'Security Officer Licencing', category: 'Compliance', type: 'Yes / No',
  ...
  {
    id: 'ndis-screening', n: 31, name: 'NDIS Screening Required', category: 'Compliance', type: 'Yes / No',
  ...
  {
    id: 'target-fte', n: 32, name: 'Target FTE', category: 'Capacity & Recruitment', type: 'Numeric',
  ...
  {
    id: 'to-be-recruited', n: 33, name: 'To be Recruited', category: 'Capacity & Recruitment', type: 'Yes / No',
  ...
  {
    id: 'multiple-holders', n: 34, name: 'Multiple Holders Allowed', category: 'Capacity & Recruitment', type: 'Yes / No',
  ...
  {
    id: 'position-criticality', n: 35, name: 'Position Criticality', category: 'Capacity & Recruitment', type: 'Dropdown (optional)',
  ...
  {
    id: 'kronos-job', n: 36, name: 'Kronos Job', category: 'Capacity & Recruitment', type: 'Dropdown',
